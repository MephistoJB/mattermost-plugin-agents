...
func TestAuditRegistryAllRoutesEmit(t *testing.T) {
	...
	tests := []struct {
		...
		{event: AuditEventUpsertRuntimePolicy, method: http.MethodPut, path: "/admin/runtime/policies/channel/channelid"},
		{event: AuditEventUpsertRuntimePolicy, method: http.MethodPut, path: "/runtime/policies/channel/channelid"},
		{event: AuditEventUpsertWorkspacePolicy, method: http.MethodPost, path: "/admin/runtime/workspace-policies"},
		{event: AuditEventUpsertWorkspacePolicy, method: http.MethodPut, path: "/admin/runtime/workspace-policies/policyid"},
		{event: AuditEventRuntimeApprovalDecision, method: http.MethodPost, path: "/runtime/approvals/approvalid/decision"},
		{event: AuditEventRuntimeApprovalDecision, method: http.MethodPost, path: "/admin/runtime/approvals/approvalid/decision"},
		{event: AuditEventRuntimeSessionAction, method: http.MethodPost, path: "/runtime/sessions/sessionid/action"},
		{event: AuditEventRuntimeSessionAction, method: http.MethodPost, path: "/admin/runtime/sessions/sessionid/action"},
		{event: AuditEventUpsertTask, method: http.MethodPost, path: "/admin/runtime/tasks/taskid/action"},
		{event: AuditEventHermesOffChecklist, method: http.MethodPut, path: "/admin/runtime/hermes-off-checklist/test_channel_soak"},
		{event: AuditEventOpenAICodexOAuthStart, method: http.MethodPost, path: "/admin/openai-codex/oauth/start"},
		{event: AuditEventOpenAICodexOAuthPoll, method: http.MethodPost, path: "/admin/openai-codex/oauth/poll"},
		{event: AuditEventOpenAICodexDisconnect, method: http.MethodDelete, path: "/admin/openai-codex/oauth"},
